...
class SimpleOracle {
    ...
    _updateWeights(newWeights = {}) {
        ...
        for (let i = 0; i < this.features.length; i++) {
            ...
            this.weights[i + offset] = (_b = combinedWeights[feature]) !== null && _b !== void 0 ? _b : this.weights[i + offset];
        }
        return this.weights;
    }
    setFeaturesAndUpdateWeights(actionIds, context, actionFeatures, contextActionIdInteractions, contextActionFeatureInteractions, weights = {}) {
        ...
        this.contextActionIdInteractions = contextActionIdInteractions !== null && contextActionIdInteractions !== void 0 ? contextActionIdInteractions : this.contextActionIdInteractions;
