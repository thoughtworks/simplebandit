    ...
    2: [
      function (require, module, exports) {
        ...
        exports.CosineSimilarity =
          exports.SampleFromProbabilityDistribution =
          exports.ConvertScoresToProbabilityDistribution =
          exports.weightedHarmonicMean =
            void 0;
        ...
        const ConvertScoresToProbabilityDistribution = (
          scores,
          temperature,
        ) => {
          if (scores.length === 0) {
          ...
          if (maxScore === -Infinity) {
            throw new Error(
              "scores array must contain at least one finite number",
            );
          }
          let probabilities = [];
        ...
        class MultiBandit {
          ...
          static fromContextAndActions({
            ...
            const actionFeatures = [
              ...new Set(
                actions.flatMap((action) => Object.keys(action.features)),
              ),
            ];
          ...
          static fromMultiBanditState(state, actions) {
            const oracle = SimpleOracle_1.SimpleOracle.fromOracleState(
              state.oracleState,
            );
          ...
          _sampleFromActionScores(actionScores) {
            ...
            MathService_1.ConvertScoresToProbabilityDistribution)(
              scores,
              this.temperature,
            );
            const sampleIndex = (0,
            MathService_1.SampleFromProbabilityDistribution)(probabilities);
            return sampleIndex;
          }
          ...
          _generateOracleTrainingData(
            ...
            for (
              ...
              const actionId =
                recommendation.recommendedActions[index].actionId;
      ...
      function (require, module, exports) {
        ...
        class SimpleBandit {
          ...
          static fromSimpleBanditState(state, actions) {
            const banditOracle = SimpleOracle_1.SimpleOracle.fromOracleState(
              state.oracleState,
            );
            const temperature = state.temperature;
            return new SimpleBandit(banditOracle, actions, temperature);
            ...
            let trainingData = [
              {
                ...
                actionFeatures:
                  this.actionsMap[recommendation.actionId].features,
        ...
        class SimpleOracle {
          constructor({
            ...
            if (
              ...
              throw new Error(
                "actionIds, context, actionFeatures must be arrays.",
              );
            }
          ...
          static fromOracleState(oracleState) {
            return new SimpleOracle({
              ...
              contextActionIdInteractions:
                oracleState.contextActionIdInteractions,
              contextActionFeatureInteractions:
              ...
              for (let i = 0; i < this.context.length; i++) {
                for (let j = 0; j < this.actionIds.length; j++) {
                  interactionFeatures.push(
                    this.context[i] + "*" + this.actionIds[j],
                  );
                }
              }
            }
          ...
          _updateWeights(newWeights = {}) {
            var _a, _b;
            const combinedWeights = Object.assign(
              {},
              this.getWeightsHash(),
              newWeights,
            );
            ...
            if (this.addIntercept) {
              this.weights[0] =
                (_a = combinedWeights["intercept"]) !== null && _a !== void 0
                  ? _a
                  : this.weights[0];
            }
            for (let i = 0; i < this.features.length; i++) {
              ...
              this.weights[i + offset] =
                (_b = combinedWeights[feature]) !== null && _b !== void 0
                  ? _b
                  : this.weights[i + offset];
            }
            return this.weights;
          ...
          setFeaturesAndUpdateWeights(
            ...
            this.actionIds =
              actionIds !== null && actionIds !== void 0
                ? actionIds
                : this.actionIds;
            this.context =
              context !== null && context !== void 0 ? context : this.context;
            this.actionFeatures =
              actionFeatures !== null && actionFeatures !== void 0
                ? actionFeatures
                : this.actionFeatures;
            this.contextActionIdInteractions =
              contextActionIdInteractions !== null &&
              contextActionIdInteractions !== void 0
                ? contextActionIdInteractions
                : this.contextActionIdInteractions;
            this.contextActionFeatureInteractions =
              contextActionFeatureInteractions !== null &&
              contextActionFeatureInteractions !== void 0
                ? contextActionFeatureInteractions
                : this.contextActionFeatureInteractions;
              ...
              for (let i = 0; i < this.context.length; i++) {
                for (let j = 0; j < this.actionFeatures.length; j++) {
                  inputsHash[this.context[i] + "*" + this.actionFeatures[j]] =
                    inputsHash[this.context[i]] *
                    inputsHash[this.actionFeatures[j]];
                }
              }
            }
            return inputsHash;
          ...
          _getOrderedInputsArray(actionId, context = {}, actionFeatures = {}) {
            ...
            if (!this._hashContainsAllKeys(inputsHash, this.allInputFeatures)) {
              ...
              throw new Error(
                `Missing features in inputsHash: ${missingFeatures}`,
              );
            }
          ...
          predict(actionId, contextInputs = {}, actionInputs = {}) {
            const logit = this._predictLogit(
              actionId,
              contextInputs,
              actionInputs,
            );
          ...
          fit(trainingData) {
            ...
            if (trainingData[this.targetLabel] !== undefined) {
              const X = this._getOrderedInputsArray(
                ...
                (_a = trainingData.context) !== null && _a !== void 0 ? _a : {},
                (_b = trainingData.actionFeatures) !== null && _b !== void 0
                  ? _b
                  : {},
              );
              ...
              if (this.useInversePropensityWeighting) {
                sampleWeight =
                  1 /
                  ((_c = trainingData.probability) !== null && _c !== void 0
                    ? _c
                    : DEFAULT_PROBABILITY);
              }
              if (y == 0) {
              ...
              for (let i = 0; i < this.weights.length; i++) {
                const gradient =
                  sampleWeight * this.learningRate * ((pred - y) * X[i]);
                this.weights[i] -= gradient;
              }
            } else {
              // Handle missing or incorrect target label
              console.error(
                `Missing or undefined target label: ${this.targetLabel}`,
              );
            }
          }
