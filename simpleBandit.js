...
class SimpleBandit {
    constructor({ oracle: oracle, actions, temperature = 0.5, slateSize = 1, }) {
...
class SimpleOracle {
    constructor({ actionIds = undefined, context = undefined, features = undefined, learningRate = 0.1, actionIdFeatures = true, actionFeatures = true, contextActionIdInteractions = true, contextActionFeatureInteractions = true, useInversePropensityWeighting = true, targetLabel = "click", name = undefined, oracleWeight = 1.0, weights = {}, } = {}) {
