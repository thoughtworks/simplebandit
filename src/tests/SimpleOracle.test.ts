...
import {ITrainingData, ISimpleOracleState, SimpleOracleOptions} from '../interfaces';
...
describe('SimpleOracle', () => {
  ...
  it('should throw error if contextInteractions is not an array', () => {
    ...
    }).toThrow("contextActionIdInteractions, contextActionFeatureInteractions, useInversePropensityWeighting must be booleans.");
  });
  ...
  describe('setFeaturesAndUpdatedWeights', () => {
    it('should set the features and updated weights', () => {
      oracle.setFeaturesAndUpdateWeights(['action1', 'action2'], ['context1'], ['feature1', 'feature2']);
  ...
  describe('hashContainsAllKeys', () => {
    it('should return true if the hash contains all the keys', () => {
      ...
      expect(
        oracle._hashContainsAllKeys(hash, ['action1', 'action2']),
      ).toEqual(true);
    });
  ...
  describe('predict', () => {
    ...
    it('should return 0.5 for all zero features', () => {
      ...
      expect(
        oracle.predict(actionId, context, actionFeatures),
      ).toEqual(0.5);
    });
    it('should return 0.73 for all features that add up to 1', () => {
      ...
      const actionId = 'action3';
      expect(
        oracle._predictLogit(actionId, context, actionFeatures),
      ).toEqual(1);
      expect(
        oracle.predict(actionId, context, actionFeatures),
